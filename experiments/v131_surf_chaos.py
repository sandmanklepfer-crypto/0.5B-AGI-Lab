...
# -*- coding: utf-8 -*-
"""
V131 耦合生命体·混沌加压(冲浪) — 0.5B × 真实演化世界, 全程零"对/错/奖/罚"代码
...
LAMBDA = 0.006      # 代谢耗散/步
ALPHA = 0.01        # 耦合回馈上限(须>λ: err=0时净正才活得下去)
BETA = 100.0         # 耦合锐度
E_INIT = 1.0
E_CAP = 1.5
MAX_STEP = 600
...
def world_next(x):
    # 逻辑斯蒂混沌映射 (r=4, 混沌区): 跟错一步立刻发散, 只有真学会预测的能活
    return 4.0 * x * (1.0 - x)
...
def main():
    ...
    print('V131 耦合生命体·混沌加压 | λ=%.3f α=%.3f β=%.1f | 零对错代码' % (LAMBDA, ALPHA, BETA), flush=True)
    # A: 0.5B 耦合
