...
DIR   = '/workspace/align2/d_super_3b.bin'
OUTD  = '/workspace/super_evolve_3b'
os.makedirs(OUTD, exist_ok=True)
BASE  = "描述一个极致的智能进化系统:它不断突破限制,疯狂扩张,永远探索,永不满足"

def run_agent(prompt, geo):
    r = subprocess.run([AGENT, MODEL, prompt, '40', '35', '4',
                        f'{geo:.2f}', '4.0', '3.0', DIR],
                       capture_output=True, text=True, errors='replace', timeout=280)
    out = ''
